...
def get_height_input():
    ...
    height_slider = widgets.FloatSlider(value=170, min=100, max=220, step=1, description="Height (cm):", continuous_update=False)
...
def get_weight_input():
    ...
    weight_slider = widgets.FloatSlider(value=70, min=30, max=200, step=0.5, description="Weight (kg):", continuous_update=False)
